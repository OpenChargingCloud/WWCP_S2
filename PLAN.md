...
Implementation status (2026-09-04): the user accepted all proposed defaults (§2, §7). Phases 0, 1a–1c,
2a–2b, 3, 4, 5, 6a/6b, 7, 8 and 9a–9c are implemented (`CONVENTIONS.md` is the binding authoring guide, `CHANGELOG.md` lists
the content); the next phase is 10 (node layer: 10a composition and end-to-end, 10b samples). Phase 9 notes: the Multicast
